...
def test_single_layer():
    ...
    assert re.search(regex, "encoder.layers.3.self_attention.layernorm_qkv")
    assert not re.search(regex, "encoder.layers.2.self_attention.layernorm_qkv")
...
def test_multiple_layers():
    ...
    assert re.search(regex, "encoder.layers.2.layernorm_mlp.fc1")
    assert re.search(regex, "encoder.layers.3.layernorm_mlp.fc2")
    assert not re.search(regex, "encoder.layers.4.self_attention.proj")
...
def test_none_returns_disabled_pattern():
    ...
    assert not re.search(regex, "encoder.layers.1.self_attention.layernorm_qkv")
...
def test_1indexed_layer_names():
    ...
    assert not re.search(regex, "encoder.layers.0.self_attention.layernorm_qkv")
...
def test_fp4_section_disabled_fp8_still_updated(fp4_fp8_config):
    ...
    assert re.search(fp8_regex, "encoder.layers.5.self_attention.proj")
    assert not re.search(fp8_regex, "encoder.layers.2.self_attention.proj")

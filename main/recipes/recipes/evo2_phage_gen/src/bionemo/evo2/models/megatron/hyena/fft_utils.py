...
# This file is copied from: recipes/evo2_megatron/src/bionemo/evo2/models/megatron/hyena/fft_utils.py
...
def linear_causal_fft_size(input_len: int, filter_len: int) -> int:
    """Return an FFT size that cannot alias a causal convolution prefix."""
    filter_len = max(input_len, filter_len)
